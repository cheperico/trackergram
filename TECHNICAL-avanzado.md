# TECHNICAL-avanzado.md — Arquitectura profunda de trackerGram

> **Nivel: conocimientos básicos a medios** — Este documento explica **cómo** y **por qué** se construyó trackerGram con detalle técnico (código, decisiones, deuda, seguridad). Para una visión general sin código, ver [`TECHNICAL-basico.md`](TECHNICAL-basico.md). Hub: [`TECHNICAL.md`](TECHNICAL.md) · Schema: [`docs/TRACKER_SCHEMA.md`](docs/TRACKER_SCHEMA.md)
...
## Apéndice: Schema completo del tracker

El schema completo de 28 campos y el INI importable se movieron a [docs/TRACKER_SCHEMA.md](docs/TRACKER_SCHEMA.md) para evitar duplicación.

Ver la tabla resumida y el INI allí. Hub: [TECHNICAL.md](TECHNICAL.md) · Básico: [TECHNICAL-basico.md](TECHNICAL-basico.md)
